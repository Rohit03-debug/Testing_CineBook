...
public class AuthTests extends BaseTest {
    ...
    @Test(groups = {"smoke", "auth", "FRD_2_1"}, description = "FRD_2.1: Login page should render username, password, and sign-in controls")
    public void FRD_201_loginPageRenders() {
        LoginPage loginPage = new LoginPage(driver).open();
        Assert.assertTrue(loginPage.isDisplayed(), "Login page should be displayed.");
    }

    @Test(groups = {"smoke", "auth", "FRD_2_1"}, description = "FRD_2.1.6: Invalid credentials should keep the user on login and show validation/error feedback")
    ...
    @Test(groups = {"smoke", "auth", "FRD_2_2"}, description = "FRD_2.2: Register page should support moviegoer registration")
    ...
    @Test(groups = {"smoke", "auth", "FRD_2_2"}, description = "FRD_2.2.3: Theater-owner registration should ask for theater name and location")
    ...
    @Test(groups = {"smoke", "auth", "security"}, description = "Protected movie catalog route should redirect unauthenticated users to login")
    ...
    @Test(groups = {"sanity", "regression", "auth", "FRD_2_1"}, description = "FRD_2.1.3-2.1.4: Valid moviegoer credentials should create a logged-in session")
    ...
    @Test(groups = {"sanity", "regression", "auth", "FRD_2_1"}, description = "FRD_2.1: Logout should end the session and return to login")
